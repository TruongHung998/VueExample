            ...
            <div class="container header-container">
                    ...
                    <div class="col-xl-3 col-lg-4 col-6">
                        <ul class="header-right">
                            <li class="d-none d-md-block">
                                <router-link class="btn btn-custom-size btn-md blackcurrant-color extbot-primary-hover" to="/contact">Sign In</router-link>
                            </li>
                ...
                <div class="setting-body" v-if="isHidden">
                    <ul class="header-right setting-item">
                        ...
                        <li>
                            <router-link class="btn btn-custom-size btn-md paua-color blackcurrant-hover" to="/contact">
                                Sign In
