            ...
            <div class="container header-container">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-3 col-lg-4 col-6">
                        <ul class="header-right">
                            ...
                            <li class="d-none d-md-block">
                                <router-link class="btn btn-custom-size btn-md sapphire-color blackcurrant-hover" to="/contact">Sign In <i class="icofont-double-right"></i></router-link>
                            </li>
                ...
                <div class="setting-body" v-if="isHidden">
                    <ul class="header-right setting-item">
                        ...
                        <li>
                            <router-link class="btn btn-custom-size btn-md sapphire-color blackcurrant-hover" to="/contact">
